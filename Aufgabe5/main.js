...
(function (A5) {
    ...
    function init() {
        ...
        for (let i = 0; i < 120; i++) {
            //NEU!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!TEST
            A5.clsnow = new A5.Schnee(10 + Math.random() * 800, 100 + Math.random() * 600);
            snowArr[i] = A5.clsnow;
        }
        for (let i = 0; i < 3; i++) {
            /*
            ...
            */
            //NEU!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!TEST
            A5.clski = new A5.Skifahrer(10, 100, Math.random() * 2 - 1, Math.random() * 2 - 1);
            skiArr[i] = A5.clski;
            /* ARRAY GEHT SO NICHT :(
            if (i == 0) {
                skiArr[i].x = 10;
            ...
            */
            //NEU!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!TEST
            A5.clwolken = new A5.Wolken(0 + Math.random() * 800, 0 + Math.random() * 80 + 50);
        }
        animate();
